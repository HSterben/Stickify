...
import { X, Pencil, FileText, Code2, Globe, ListChecks, ExternalLink } from "lucide-react";
              ...
              <div className="flex items-start justify-between gap-4">
                <div className="min-w-0 flex-1">
                  <div className="mb-2 flex flex-wrap items-center gap-2">
                    <div className={cn("flex h-7 w-7 items-center justify-center rounded-lg", badge.bg)}>
